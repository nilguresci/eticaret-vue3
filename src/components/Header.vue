...
"
    ...
    <div class="right">
      <div class="help">Yardım</div>
      <div class="blog"><div>Blog</div></div>
    </div>
  </div>
  <div class="headerSecondLine">
    <div class="secondLineLeft">
      <button
        class="navbar-toggler toggler-example menuButton"
        type="button"
      ...
      <div class="siteHeader">
        <router-link to="/" class="btn p-0">
          <h4 class="title">{{ header }}</h4></router-link
        >

        <div class="smallText">Evinizin yanında</div>
      </div>
    </div>
    <div class="secondLineRight">
      <div class="searchBar">
          ...
          <ul class="dropdown-menu">
            <li>
              <router-link class="dropdown-item" to="/login"
                >Giriş yap veya üye ol</router-link
              >
            </li>
          </ul>
        </div>
      ...
      <div class="basket">
        ...
        <div>
          <router-link class="basketText" to="/basket">Sepet</router-link>

          <div class="basketCount">1120 TL</div>
        </div>
      </div>
    </div>
  </div>
