  ...
  <div class="footer">
    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <ul>
          <li><a href="">Sipariş Sorgulama</a></li>
      ...
      <div class="col">
        ...
        <ul>
          <li>
            <div class="textBold">Adres:</div>
            Şehit Polis Fethi Sekin Cad. No: 1/706 Martı Tower, Konak - İzmir
          </li>
          <li>
            <div class="textBold">Telefon:</div>
            0 850 345 67 89
          </li>
        </ul>
      </div>
